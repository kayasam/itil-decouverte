...
> [!TIP] Ressource du TP
>
> - <a href="https://kayasam.github.io/itil-decouverte/telechargements/tp/05-tp-serveur-individuel.md" download>Télécharger ce TP en Markdown</a>
...
| Qui doit l'approuver au Fournil Doré ? _(l'entreprise n'a pas de CAB formel — le technicien dépend directement du directeur)_ |               |
...
Connectez-vous avec le compte **thomas.martin**.
...
Une fois le changement créé, ouvrez-le → section **Liaisons** → **+ Ajouter** → rechercher et sélectionner **votre** problème `Pannes récurrentes - IMP-NAN-OPENSPACE-01` créé au chapitre 04.
...
- [ ] Le changement est lié au problème du chapitre 04
