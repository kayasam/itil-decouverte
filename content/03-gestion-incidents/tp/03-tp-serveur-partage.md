...
# 03 — La gestion des incidents · TP — serveur mutualisé

> [!TIP] Ressource du TP
>
> - <a href="https://kayasam.github.io/itil-decouverte/telechargements/tp/03-tp-serveur-partage.md" download>Télécharger ce TP en Markdown</a>
...
Connectez-vous à GLPI avec **votre compte personnel**.
...
| Titre             | `[VotrePrénom]` + un titre court et clair                                                       |
...
| ----------- | ------------------------------------------------------- |
| Type        | **Demande**                                             |
| Titre       | `[VotrePrénom] Demande d'un deuxième écran`             |
...
- [ ] 4 tickets de type **Incident** créés, tous préfixés de mon prénom
...
- [ ] En tapant mon prénom dans la recherche, je retrouve bien mes 5 tickets
